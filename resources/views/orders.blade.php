...
<body class="min-h-screen flex bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100" x-data="ordersHistoryApp()">
    ...
    <div class="flex-grow flex flex-col overflow-hidden h-screen">
        ...
        <!-- ── Top Header ── -->
        <header class="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 px-5 py-3 flex items-center justify-between gap-4 flex-shrink-0 z-20">
